  ...
  return (
    <div className="min-h-screen text-white" style={{ background: '#0a0a0a', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="grain">
        ...
        {/* ═══ Breadcrumb Capital Founder Consulting ═══ */}
        <div className="relative z-20 px-6 md:px-12 lg:px-20 pt-3 pb-1">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-[2px] transition-colors hover:text-[color:#c8a15a]"
            style={{ color: 'var(--dim)' }}
          >
        ...
        {/* ═══ NAV ═══ */}
        <nav className="relative z-20 flex items-center justify-between px-6 md:px-12 lg:px-20 py-4">
          <Link href="/capital-cfo" className="flex items-center gap-2.5">
